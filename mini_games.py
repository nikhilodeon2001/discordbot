...
GAME_NAMES = [
    ...
    "sign language", "elementary", "jigsawed", "geokraphy", "faceoff", "rushmore",
...
def _get_game_function(game_name: str):
    ...
    game_function_map = {
        ...
        "geokraphy": ask_geokraphy_challenge,
        ...
        "where's okra": ask_wheres_okra_challenge
    }
